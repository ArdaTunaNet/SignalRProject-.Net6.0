    ...
    public class ContactController : ControllerBase
    {
        ...
        public IActionResult CreateContact(CreateContactDto createContactDto)
        {
            _contactService.TAdd(new Contact { 
                ...
                ContactLocationDescriptionfooter = createContactDto.ContactLocationDescriptionfooter,
        ...
        public IActionResult UpdateContact(UpdateContactDto updateContactDto)
        {
            _contactService.TUpdate(new Contact()
            {
               ...
               ContactLocationDescriptionfooter=updateContactDto.ContactLocationDescriptionfooter,
               ContactMail=updateContactDto.ContactMail,
            });
            return Ok("İletisim Bilgileri Güncellendi");
        }
        [HttpGet("{id}")]
